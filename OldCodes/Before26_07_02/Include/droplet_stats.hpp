...
// TODO not sure if i am seeding it correctly
static std::random_device rd; // seed
static std::mt19937_64 gen(rd()); // TODO seed it from a set of random devices
...
static const double sat_mu = 10.15; // Mean velocity   
static const double sat_b  = 0.58;  // Scale parameter 
